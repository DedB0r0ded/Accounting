...
namespace accounting {
  ...
  bool Transfer::validate_conversion_rate() const {
    ...
    return is_close(conversion_rate_, actual_rate, 1e-4);
  }
  ...
  Transfer::Transfer(lid_t id, const tm& date_time, double conversion_rate,
                     sp<Account> debit_account, i32 debit_amount,
                     sp<Account> credit_account, i32 credit_amount) noexcept
      : id_{id},
        date_time_{Time::from_tm(date_time).value()},
  ...
  Transfer::Transfer(lid_t id, const tm& date_time, sp<Account> debit_account,
                     i32 debit_amount, sp<Account> credit_account,
  ...
  Transfer::Transfer(lid_t id, const tm& date_time, sp<Account> debit_account,
                     sp<Account> credit_account, i32 amount) noexcept
  ...
  const sp<Account> Transfer::debit_account() const {
  ...
  const sp<Account> Transfer::credit_account() const {
  ...
  void Transfer::set_date_time(const Time& date_time) {
