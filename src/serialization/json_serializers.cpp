...
namespace accounting {
  ...
  void from_json(const nlohmann::json& j, Transfer& obj) {
    ...
    obj.set_conversion_rate(j.at(JSON_TRANSFER_CONVERSION_RATE_KEY).get<double>());
    obj.set_state_switch(j.at(JSON_TRANSFER_STATE_KEY).get<TransferStateSwitch>());
    ...
    obj.set_debit_amount(j.at(JSON_TRANSFER_DEBIT_AMOUNT_KEY).get<accounting::lid_t>());
